...
@Data
@ApiModel(value="TraineeJobRelVO", description="实习生的岗位信息")
public class TraineeJobRelVO {
    ...
    @ApiModelProperty(value = "实习生的岗位信息", name = "traineeJobRelDTOS")
    private List<TraineeJobRelDTO> traineeJobRelDTOS;
}
